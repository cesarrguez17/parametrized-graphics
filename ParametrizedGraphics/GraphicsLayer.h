...
protected:
	...
	ID3D11Buffer				*m_pConstantLightsBuffer;
...
struct CONSTANTS_MATRICES
{
	...
	D3DXVECTOR4 g_vMouse;
};

struct CONSTANTS_LIGHTS
{
	D3DXVECTOR4 g_Ambient;
	D3DXVECTOR4 g_Diffuse;
	D3DXVECTOR4 g_Specular;
	D3DXVECTOR4 g_vLightPos[NUM_LIGHTS];
	D3DXVECTOR4 g_vLightColor[NUM_LIGHTS];
